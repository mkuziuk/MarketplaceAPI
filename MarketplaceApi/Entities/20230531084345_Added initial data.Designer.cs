...
namespace MarketplaceApi.Entities
{
    ...
    [Migration("20230531084345_Added initial data")]
            ...
            modelBuilder.Entity("MarketplaceApi.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2023, 5, 31, 11, 43, 45, 14, DateTimeKind.Local).AddTicks(379),
                            Height = 6,
                            InStockQuantity = 20,
                            IsPublic = true,
                            Length = 6,
                            ...
                            Name = "ball",
                            Price = 1500,
                            PublicationDate = new DateTime(2023, 5, 31, 11, 43, 45, 14, DateTimeKind.Local).AddTicks(816),
                            ShopId = 1,
                            Type = 1,
                            UseCase = 1,
                            UserId = 2,
                        ...
                        {
                            Id = 2,
                            CreationDate = new DateTime(2023, 5, 31, 11, 43, 45, 14, DateTimeKind.Local).AddTicks(1544),
                            Height = 16,
                            InStockQuantity = 25,
                            IsPublic = true,
                            Length = 5,
                            ...
                            Name = "tower",
                            Price = 2500,
                            PublicationDate = new DateTime(2023, 5, 31, 11, 43, 45, 14, DateTimeKind.Local).AddTicks(1563),
                            ShopId = 1,
                            Type = 2,
                            UseCase = 2,
                            UserId = 2,
            ...
            modelBuilder.Entity("MarketplaceApi.Models.Shop", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2023, 5, 31, 11, 43, 45, 13, DateTimeKind.Local).AddTicks(5707),
                            Name = "shop1",
                            OwnerId = 2
                        });
                });
            ...
            modelBuilder.Entity("MarketplaceApi.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "User1",
                            Phone = "+71111111111",
                            RegistrationDate = new DateTime(2023, 5, 31, 11, 43, 45, 7, DateTimeKind.Local).AddTicks(8255),
                            SecondName = "User1",
                            Seller = false
                        },
                        new
                        {
                            ...
                            FirstName = "User2",
                            Phone = "+72222222222",
                            RegistrationDate = new DateTime(2023, 5, 31, 11, 43, 45, 12, DateTimeKind.Local).AddTicks(1891),
                            SecondName = "User2",
                            Seller = true
                        },
                        new
                        {
                            ...
                            FirstName = "User3",
                            Phone = "+73333333333",
                            RegistrationDate = new DateTime(2023, 5, 31, 11, 43, 45, 12, DateTimeKind.Local).AddTicks(2136),
                            SecondName = "User3",
                            Seller = false
                        });
                });
