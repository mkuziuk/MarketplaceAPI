...
namespace MarketplaceApi.Entities
{
    ...
    [Migration("20230531133447_first order with special status")]
    partial class firstorderwithspecialstatus
    {
            ...
            modelBuilder.Entity("MarketplaceApi.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2023, 5, 31, 16, 34, 46, 475, DateTimeKind.Local).AddTicks(3638),
                            OrderStatusId = 99,
                            UserId = 3,
                            WayOfPayment = 0
                        });
            ...
            modelBuilder.Entity("MarketplaceApi.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2023, 5, 31, 16, 34, 46, 475, DateTimeKind.Local).AddTicks(1277),
                            Height = 6,
                            InStockQuantity = 20,
                            IsPublic = true,
                            Length = 6,
                            ...
                            Name = "ball",
                            Price = 1500,
                            PublicationDate = new DateTime(2023, 5, 31, 16, 34, 46, 475, DateTimeKind.Local).AddTicks(1719),
                            ShopId = 1,
                            Type = 1,
                            UseCase = 1,
                            UserId = 2,
                        ...
                        {
                            Id = 2,
                            CreationDate = new DateTime(2023, 5, 31, 16, 34, 46, 475, DateTimeKind.Local).AddTicks(2468),
                            Height = 16,
                            InStockQuantity = 25,
                            IsPublic = true,
                            Length = 5,
                            ...
                            Name = "tower",
                            Price = 2500,
                            PublicationDate = new DateTime(2023, 5, 31, 16, 34, 46, 475, DateTimeKind.Local).AddTicks(2488),
                            ShopId = 1,
                            Type = 2,
                            UseCase = 2,
                            UserId = 2,
            ...
            modelBuilder.Entity("MarketplaceApi.Models.Shop", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2023, 5, 31, 16, 34, 46, 474, DateTimeKind.Local).AddTicks(4612),
                            Name = "shop1",
                            OwnerId = 2
                        });
                });
            ...
            modelBuilder.Entity("MarketplaceApi.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "User1",
                            Phone = "+71111111111",
                            RegistrationDate = new DateTime(2023, 5, 31, 16, 34, 46, 467, DateTimeKind.Local).AddTicks(8412),
                            SecondName = "User1",
                            Seller = false
                        },
                        new
                        {
                            ...
                            FirstName = "User2",
                            Phone = "+72222222222",
                            RegistrationDate = new DateTime(2023, 5, 31, 16, 34, 46, 472, DateTimeKind.Local).AddTicks(8588),
                            SecondName = "User2",
                            Seller = true
                        },
                        new
                        {
                            ...
                            FirstName = "User3",
                            Phone = "+73333333333",
                            RegistrationDate = new DateTime(2023, 5, 31, 16, 34, 46, 472, DateTimeKind.Local).AddTicks(8924),
                            SecondName = "User3",
                            Seller = false
                        });
                });
